...
✍️ **ช่องข้อความมีรูปแบบ (rich text · 27 ก.ค. 2569):** `js/ui/richtext.js` = `richFieldHtml`/`bindRichFields`/`sanitizeHtml`/`richToText` · ใช้กับช่อง type `area` ทั้ง Pending + Book 3 สี
