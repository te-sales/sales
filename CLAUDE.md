...
🔎 **ตัวกรองขอบเขต Pending/Book3 = คอมโพเนนต์ร่วม 2 ตัว ใช้ต่อกัน (ทีม → คน) ห้ามก๊อป**
   ...
   · **ค่าเริ่มต้น = ตัวเอง** (เจ้าของสั่ง 27 ก.ค. 2569): เปิดหน้ามา `view.person` ตั้งต้นเป็น meId (ถ้ายังไม่เลือกเจาะจง) → แสดงงาน/ลูกค้าของ user ที่ล็อกอิน · "ทุกคน" (person='') เลือกได้ แต่เปิดใหม่กลับมาตั้งต้นที่ตัวเอง · เลือกคนอื่นเจาะจง = จำค่า
